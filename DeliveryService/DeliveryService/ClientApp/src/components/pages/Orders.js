...
class Orders extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(url)
            .then((response) => this.GotList(response));
    }

    GotList(response)
    {
        if (response.data.role == null)
            document.location.href = "/TheNew/";
        else this.setState({ active: response.data.active, available: response.data.available, past: response.data.past, role: response.data.role, loading: false });
    }
