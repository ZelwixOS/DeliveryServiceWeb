...
namespace Tests.BLL.dbOperationsTests
{
    public class UpdateOrderTests
    {
        ...
        {
            OrderModel order = new OrderModel() { ID = 1, AddNote = "", Cost = 120, AdressDestination = "Dest1", AdressOrigin = "Orig1", Courier_ID_FK = "2", Customer_ID_FK = "3", Deadline = new DateTime(2200, 1, 12), Delivery_ID_FK = null, OrderDate = new DateTime(2021, 10, 6), ReceiverName = "user1", Status_ID_FK = 0 };
            UserModel user = new UserModel(UserUtility.GetCustomer());
            int expected = 1;

            await factory.CreateDbInitalizer().InitDataBaseAsync(x =>
            {
                x.Order.Add(new Order() { ID = 1, AddNote = "", Cost = 120, AdressDestination = "Destination1", AdressOrigin = "Origin1", Courier_ID_FK = "2", Customer_ID_FK = "3", Deadline = new DateTime(2200, 12, 12), Delivery_ID_FK = null, OrderDate = new DateTime(2021, 10, 6), ReceiverName = "user1", Status_ID_FK = 0 });
            });
